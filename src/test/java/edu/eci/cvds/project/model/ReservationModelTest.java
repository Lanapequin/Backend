...
class ReservationModelTest {
    ...
    void testConstructorAndGettersAndSetters() {
        ...
        Reservation reservation = new Reservation(id, laboratory, user, startDateTime, endDateTime, purpose, status);

        assertEquals(id, reservation.getId());
        assertEquals(laboratory, reservation.getLaboratory());
    ...
    void testToString() {
        ...
        String expectedString = "Reservation(id=RES-001, laboratory=" + laboratory.toString() + ", user=" + user.toString() + ", startDateTime=" + startDateTime.toString() + ", endDateTime=" + endDateTime.toString() + ", purpose=Project meeting, Status=true)";
